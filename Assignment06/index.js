...
const str = "white";
const str1 = "red";
const notEqual = str == str1;
console.log("white and red equal? ", notEqual);
const equal = str !== str1;
console.log(equal);
//test using lower case
var inputStr = "Iphone Apple";
...
const x = true;
const y = false;
const andResult = x && y; // False (both conditions must be true)
const orResult = x || y; // True (at least one condition must be true)
console.log("And operator test:", andResult);
console.log("Or operator test:", orResult);
// Test whether an item is in an array
const fruits = ["apple", "banana", "cherry", "date"];
const isInArray = fruits.includes("banana"); // True
console.log("Item in array test:", isInArray);
// Test whether an item is not in an array
const isNotInArray = !fruits.includes("grape"); // True
